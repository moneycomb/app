MoneyMindset = new Mongo.Collection('moneymindset');
...
MoneyMindsetSchema = new SimpleSchema({
...
MoneyMindset.attachSchema(MoneyMindsetSchema);


// see: meteor add matb33:collection-hooks
MoneyMindset.before.insert(function (userId, doc) {
...
MoneyMindset.before.update(function (userId, doc) {
