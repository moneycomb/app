/*****************************************************************************/
/* RecatHex: Event Handlers */
/*****************************************************************************/
Template.RecatHex.events({
...
/*****************************************************************************/
/* RecatHex: Lifecycle Hooks */
/*****************************************************************************/
Template.RecatHex.onCreated(function () {
  this.recatLabel = new ReactiveVar(MoneyComb.singlecellname(this.data.cell));
  this.recatCell = new ReactiveVar('u');
});

Template.RecatHex.onRendered(function () {
});

Template.RecatHex.onDestroyed(function () {
});
